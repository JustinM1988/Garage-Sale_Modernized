// config.js — GitHub Pages Configuration for City of Portland
window.CONFIG = {
...
APP_LOG.info("🏛️ City of Portland Garage Sale Admin v8.0 - Configuration Loaded");
...
if (typeof L === 'undefined') {
    APP_LOG.error("❌ Leaflet library not loaded! Map will not work.");
} else {
    APP_LOG.success("✅ Leaflet library loaded successfully");
}
